...
def main():
    ...
    # args.output_dir = os.path.join(data_root, '../processed')
    args.output_dir = '/home/work/StripedMarlin/sohyun/vocal-remover/noises_raw'
    ...
    for file in tqdm(os.listdir(data_root)):
        ...
        if args.output_image:
            ...
            utils.imwrite('{}{}_Noise.jpg'.format(output_dir, basename), image)
